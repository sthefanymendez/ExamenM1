...
describe("Ejercicio 05 - tipologiasSeparadas", () => {
  ...
  test("La función debe crear y retornar el Stack creado con las casas de forma correcta, sin tipologías repetidas . ", () => {
  ...
  test("En caso de que no hayan tipologias repetidas debe retornar 'No hay tipologías repetidas'", () => {
    expect(tipologiasSeparadas([1, 2, 3, 4, 5, 6, 7, 8, 9])).toBe(
      "No hay tipologías repetidas"
    );
